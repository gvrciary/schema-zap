...
export const SQL_DATA_TYPES: Record<string, string[]> = {
	...
	[SQLDialect.MARIADB]: [
		...
		'BINARY', 'VARBINARY', 'CHAR BYTE',
		'TINYTEXT', 'TEXT', 'MEDIUMTEXT', 'LONGTEXT',
		'TINYBLOB', 'BLOB', 'MEDIUMBLOB', 'LONGBLOB',
		'LONG', 'LONG VARCHAR', 'LONG VARBINARY',
		'NATIONAL CHAR', 'NATIONAL VARCHAR', 'NCHAR', 'NVARCHAR',
		'DATE', 'TIME', 'DATETIME', 'TIMESTAMP', 'YEAR',
		'BOOLEAN', 'BOOL',
		'JSON',
		'ENUM', 'SET',
...
export const REQUIRED_LENGTH_TYPES: Record<string, string[]> = {
	...
	[SQLDialect.MARIADB]: [
		'CHAR', 'CHARACTER', 'VARCHAR', 'CHAR VARYING', 'CHARACTER VARYING',
		'BINARY', 'VARBINARY', 'CHAR BYTE', 'BIT',
		'NATIONAL CHAR', 'NATIONAL VARCHAR', 'NCHAR', 'NVARCHAR'
	]
};
...
export const OPTIONAL_LENGTH_TYPES: Record<string, string[]> = {
	...
	[SQLDialect.POSTGRESQL]: [
		'DECIMAL', 'NUMERIC', 'TIME', 'TIMESTAMP', 'TIMESTAMPTZ', 'INTERVAL'
	],
	[SQLDialect.SQLITE]: [
		'CHARACTER', 'VARCHAR', 'VARYING CHARACTER', 'NCHAR',
		'NATIVE CHARACTER', 'NVARCHAR', 'NUMERIC', 'DECIMAL'
	],
	[SQLDialect.MARIADB]: [
		'TINYINT', 'SMALLINT', 'MEDIUMINT', 'INT', 'INTEGER', 'BIGINT',
		'INT1', 'INT2', 'INT3', 'INT4', 'INT8', 'MIDDLEINT',
